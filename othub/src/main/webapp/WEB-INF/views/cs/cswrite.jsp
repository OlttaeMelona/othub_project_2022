...
<div class="top_info">
	...
	<button type="submit" class="cs_submit">작성</button>
	
	</div>	
	
	<input type="hidden" name="cs_writer" value="${cs_writer}" /><br>
	
	<input type="text" name="cs_title" class="cs_title" required placeholder="  제목을 입력해주세요"/><br>
	
	<textarea cols="50" rows="5" name="cs_question" required style="resize:none;"
	required placeholder="  문의하실 내용을 입력해주세요" class="cs_question"></textarea><br>
