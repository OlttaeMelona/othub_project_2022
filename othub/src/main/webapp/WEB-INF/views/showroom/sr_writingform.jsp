		...
		<section class="writingform">
			<form action="uploadpost" method="post" enctype="multipart/form-data">
				...
				<div class="sr_input">
					...
					<input id="member_post"  type="text" name="sr_adress1" placeholder="우편번호 (주소를 검색하려면 클릭해주세요)" readonly onclick="findAddr()"><br>
					<input id="member_addr" type="text" name="sr_adress2" placeholder="점포 주소를 입력해주세요." readonly> <br>
					<input type="text" name="sr_adress3" placeholder="상세 주소를 입력해주세요.">
				</div>
