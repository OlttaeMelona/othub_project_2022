...
<input type="text" name="p_name" id="p_name" required placeholder="상품명" required value="${getproduct.p_name}"> <br>

<input type="text" name="p_brand" id="p_brand" required placeholder="브랜드명" required value="${getproduct.p_brand}"> <br>

<input type="number" name="p_price" id="p_price" required placeholder="가격" required value="${getproduct.p_price}"> 

<input type="number" name="p_stock" id="p_stock" required placeholder="재고" required value="${getproduct.p_stock}"> <br>
